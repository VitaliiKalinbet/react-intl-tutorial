...
function App() {
  ...
  const [language, setLanguageValue] = useState(defaultLanguage);
  const currentLanguageCode = language || "en";
            ...
            <ul className='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
              <li>
                <span className='dropdown-item-text'>
                  <FormattedMessage
                    id='language'
                    defaultMessage='Choosen Language'
        ...
        <div className='d-flex flex-column align-items-start'>
          ...
          <p>
            <FormattedMessage
              ...
              defaultMessage='Days since release'
              description='Days since release'
